...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Feb 23. 23:01
...
(17, 'neve', 'leiras', 2, 'merete', 600, 'kep');
...
INSERT INTO `rendeles` (`rendeles_id`, `rendelo_neve`, `rendelt_termek_fajtaja`, `rendelt_termek_neve`, `rendeles_mennyisege`) VALUES
(1, 'Sprint Elek', 'Fa', 'Deszka', 15);
...
--
ALTER TABLE `anyag`
  MODIFY `anyag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
